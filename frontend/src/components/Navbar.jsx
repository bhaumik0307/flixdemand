...
const Navbar = ({setIsAuthenticated}) => {
  ...
  return (
    <div className='bg-[#111111] text-white flex pt-8 pb-6 px-8 w-full'>
      <img src={logo} className='w-[150px] rounded-xl mr-10' alt="img" />
      <div className='flex justify-center items-center w-[60%] space-x-8'>
      <NavLink 
      ...
      <div className='flex justify-between w-[38%] px-4'>
